        ...
        private void btnEditar_Click(object sender, EventArgs e)
        {
            try
            {
                if (dgProveedor.SelectedRows.Count > 0)
                {
                    ...
                    txtNDocumento.Text = dgProveedor.CurrentRow.Cells[2].Value.ToString();
                    txtCorreo.Text = dgProveedor.CurrentRow.Cells[3].Value.ToString();
                    txtTelefono.Text = dgProveedor.CurrentRow.Cells[4].Value.ToString();
                    txtURL.Text = dgProveedor.CurrentRow.Cells[5].Value.ToString();
